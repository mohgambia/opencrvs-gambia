...
import { LANGUAGES_SOURCE } from '@resources/gmb/constants'
import * as Contentful from 'contentful'
import {
  SUPPORTED_LOCALES,
  SPACE_ID,
  USER_ID
} from '@resources/gmb/features/languages/scripts/constants'
import { contentfulTemplate } from '@resources/gmb/features/languages/scripts/contentful-template'
