...
import { getFromFhir, sendToFhir } from '@resources/gmb/features/utils'
import chalk from 'chalk'
import { logger } from '@resources/logger'
import User, { IUserModel } from '@resources/gmb/features/employees/model/user'
import {
  generateSaltedHash,
  convertToMSISDN,
  ISaltedHash
...
import {
  createUsers,
  getScope
} from '@resources/gmb/features/employees/scripts/manage-users'
...
export async function composeAndSavePractitioners(
  ...
  for (const practitioner of practitioners) {
    ...
    const user = new User({
      ...
      mobile: convertToMSISDN(practitioner.mobile, 'gmb'),
